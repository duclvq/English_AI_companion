  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-8">
        <h1 className="text-2xl font-bold text-center mb-2">English AI Companion</h1>
        <p className="text-slate-500 text-center mb-6 text-sm">Sign in to continue learning</p>
        ...
        <p className="text-center text-sm text-slate-500 mt-4">
          No account? <a href="/register" className="text-brand font-medium hover:underline">Register</a>
        </p>
      </div>
    </div>
  );
